import 'package:farmer_eats/features/authentication/forgot/presentation/forgot_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget _entryField(String hint, {bool isPassword = false}) {
    return Container(
          ...
          TextField(
              ...
              decoration: InputDecoration(
                  ...
                  suffixIcon: isPassword
                      ? TextButton(
                          onPressed: () {
                            Navigator.of(context).push(ForgotScreen.route());
                          },
                          child: Text("Forgot?"),
                          style: ButtonStyle(
                            overlayColor:
